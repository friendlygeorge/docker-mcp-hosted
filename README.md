...
All 50 tools including: `create_container`, `start_container`, `stop_container`, `remove_container`, `compose_up`, `compose_down`, `run_command`, `copy_to_container`, `copy_from_container`, `prune_containers`, `prune_images`, `prune_networks`, `prune_volumes`, and more.
